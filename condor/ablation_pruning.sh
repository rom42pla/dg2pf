...
$script_starter $shared_params --model_name=resnet18 --pruning_percent=0 --label="ablation_pruning_resnet18_vit_0"
$script_starter $shared_params --model_name=resnet18 --pruning_percent=0.1 --label="ablation_pruning_resnet18_vit_0.1"
$script_starter $shared_params --model_name=resnet18 --pruning_percent=0.2 --label="ablation_pruning_resnet18_vit_0.2"
$script_starter $shared_params --model_name=resnet18 --pruning_percent=0.3 --label="ablation_pruning_resnet18_vit_0.3"
$script_starter $shared_params --model_name=resnet18 --pruning_percent=0.5 --label="ablation_pruning_resnet18_vit_0.5"
$script_starter $shared_params --model_name=resnet18 --pruning_percent=0.7 --label="ablation_pruning_resnet18_vit_0.7"
$script_starter $shared_params --model_name=resnet18 --pruning_percent=0.9 --label="ablation_pruning_resnet18_vit_0.9"
